    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#FDF8F5] via-[#FFF5EE] to-[#FAE8DE] text-brand-primary font-sans pb-24">
            ...
            <div className="sticky top-16 z-40 bg-gradient-to-b from-[#FDF8F5] via-[#FDF8F5] to-[#FDF8F5]/95 backdrop-blur-sm pt-3 pb-3 px-4 text-center shadow-[0_4px_15px_rgba(0,0,0,0.05)]">
                ...
                {/* PRODUK TERBATAS - Single Line */}
                <div className="flex items-center justify-center gap-3 mt-1">
                    <span className="h-[2px] w-10 sm:w-20 bg-gradient-to-r from-transparent to-[#997B2C]"></span>
                    <p className="font-serif text-base sm:text-lg text-[#997B2C] tracking-wider flex items-center gap-2 uppercase font-bold whitespace-nowrap">
                        PRODUK TERBATAS <Sparkles className="w-4 h-4 text-[#EDD686]" />
                    </p>
                    <span className="h-[2px] w-10 sm:w-20 bg-gradient-to-l from-transparent to-[#997B2C]"></span>
                </div>
            </div>
