 ...
 * agar sesuai dengan interface Product yang digunakan frontend
 *
 * USAGE: Jalankan 1x untuk memperbaiki struktur data
 */
...
export const rollbackMigration = async () => {
  console.log('⚠️ Rollback functionality - use with caution!');
  // TODO: Implement rollback based on backup
};
